...
<body>
    ...
    echo "<br>";
    echo "<ol>";
    echo "<li> $kids[0] <br></li>";
    echo "<li> $kids[1] <br></li>";
    echo "<li> $kids[2] <br></li>";
    echo "<li> $kids[3] <br></li>";
    echo "<li> $kids[4] <br></li>";
    echo "<li> $kids[5] <br></li>";
    // Lanjutkan

    echo "</ol>";
    $totalAdoult = count($adults);
    echo "Total Adults: $totalAdoult"; // Berapa panjang array adults
    echo "<br>";
    echo "<ol>";
    echo "<li> $adults[0] <br></li>";
    echo "<li> $adults[1] <br></li>";
    echo "<li> $adults[2] <br></li>";
    echo "<li> $adults[3] <br></li>";
    echo "<li> $adults[4] <br></li>";
    // Lanjutkan
